...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2858391471ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rafael_hotels&table=hotel_rooms">`rafael_hotels`.`hotel_rooms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rafael_hotel&table=booked_rooms">`rafael_hotel`.`booked_rooms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rafael_hotel&table=hotel_rooms">`rafael_hotel`.`hotel_rooms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rafael_hotels&table=users">`rafael_hotels`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rafael_hotel&table=users">`rafael_hotel`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=earlycode_hotels&table=users">`earlycode_hotels`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=earlycode_hotels&table=rooms">`earlycode_hotels`.`rooms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=earlycode_hotels&table=bookings">`earlycode_hotels`.`bookings`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mywebsite&table=ra_users">`mywebsite`.`ra_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=earlycode_transports&table=users">`earlycode_transports`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2c582446492a2d4f79685151636e3947">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="rafael_hotel" targettable="hotel_rooms">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `hotel_rooms`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="rafael_hotel" targettable="booked_rooms">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `booked_rooms`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="rafael_hotel" targettable="booked_rooms">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `booked_rooms`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="rafael_hotels" targettable="hotel_rooms">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
