<?php
 ...
 $title = 'Room Payment | Rafael Hotels';
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/portal_header.css">
...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="card" style="width: 18rem;margin:0 auto;margin-top:80px;margin-bottom:30px">
            ...
            <h6>Payment For: <?php echo $row['room_name']; ?></h6>

            <h6>Amount:</h6>
            </div>
        
            <div class="card-body">
            <p class="card-text" style="text-align: left;">Full name: <?php echo $row['first_name'].' '. $row['last_name']; ?></p>
            <p class="card-text" style="text-align: left;">Email: <?php echo $row['email']; ?></p>
            <p class="card-text" style="text-align: left;">Phone number: <?php echo $row['phone']; ?></p>
            <hr>
...
<?php require_once '../assets/includes/portal_footer.php' ?>
